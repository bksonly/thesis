...
\sjtusetup{
  ...
  info = {%
    ...
    en / title           = {Optimal Control of Quadrotor UAVs Based on High-Order Fully Actuated System Theory},
    %
    % 标题页标题
    %   可使用“\\”命令手动控制换行
    %
    ...
    % 关键词
    %
    zh / keywords        = {高阶全驱, 姿态控制, 四旋翼, 最优控制},
    en / keywords        = {high-order fully actuated, attitude control, quadrotor,optimal control},
    %
    % 姓名
    %
    zh / author          = {赵泽源},
