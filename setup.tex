...
\sjtusetup{
  ...
  info = {%
    ...
    % 标题
    %
    zh / title           = {基于高阶全驱系统理论的\\四旋翼飞行器最优控制},
    en / title           = {Optimal Control of Quadrotor Based on High-Order Fully Actuated System Theory},
    %
    % 标题页标题
    %   可使用“\\”命令手动控制换行
    %
    ...
    % 关键词
    %
    zh / keywords        = {高阶全驱系统, 姿态控制, 四旋翼飞行器, 最优控制},
    en / keywords        = {high-order fully actuated system, attitude control, quadrotor,optimal control},
    %
    % 姓名
    %
    zh / author          = {赵泽源},
    ...
    % 指导教师
    %
    zh / supervisor      = {李贤伟 副教授},
    en / supervisor      = {Associate Prof. Li Xianwei},
    %
    % 副指导教师
    %
...
% 定义图片文件目录与扩展名
\graphicspath{{figures/}{matlab_figures/}{sitl_figure/}}
